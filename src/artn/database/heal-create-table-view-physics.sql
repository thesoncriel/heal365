/* 물리치료 테이블 - 2014.01.07 by shkang [시작] */
...
create table if not exists heal_medi_physics_conf (
id					int not null auto_increment,
...
create index heal_medi_physics_conf_index1
on heal_medi_check_conf (id_medi);

create index heal_medi_physics_conf_index2
on heal_medi_check_conf (id_medi, id_medi_check_field);

create table if not exists heal_medi_physics_data (
id					int not null auto_increment,
id_complete			int,
id_pres				int,
id_medi				int not null default 0,
...
pain_site_check     INT NOT NULL DEFAULT 0,
...
create index heal_medi_physics_data_index1
on heal_medi_check_data (id_complete);

create index heal_medi_physics_data_index2
on heal_medi_check_data (id_medi);

create index heal_medi_physics_data_index3
on heal_medi_check_data (id_user);

create index heal_medi_physics_data_index4
on heal_medi_check_data (user_name);


create table if not exists heal_medi_physics_complete (
...
create index heal_medi_physics_complete_index1
on heal_medi_check_complete (id_medi);

create index heal_medi_physics_complete_index2
on heal_medi_check_complete (id_user);


create table if not exists heal_medi_physics_complete_conf (
id_medi			int not null default 0,
...
/* 물리치료 테이블 - 2014.01.07 by shkang [종료] */