...
public class MediCheckFieldAction extends AbsHeal365ActionController {
	...
	public String list() throws Exception {
		doList("medi-check-field-all");
		return SUCCESS;
	}

	@Override
	public String show() throws Exception {
		doShow("medi-check-field-single");
	...
	public String modify() throws Exception {
		...
		doEdit("medi-check-field-modify");
