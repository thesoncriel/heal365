...
<div class="footer board">
	<div class="buttons">
		...
		<s:if test='%{auth.isAdmin}'><a href="delete?id=${showData.id }&contents=${contentsCode }" class="artn-button board">삭제</a></s:if> <a href="list?contents=${contentsCode }" class="artn-button board">목록</a>
	</div>
</div>
