...
<td><a:img src="/upload/product/img/${showData.file_img }" alt="상품 사진" srcNone="/img/none.png" altNone="상품 사진 없음 - 상품 등록 후 적용 됩니다." width="320" height="240" /><br/>
...
<td><input type="text" name="id_opt_group" value="${showData.id_opt_group }" title="상품 옵션을 입력하세요."/></td></tr>
