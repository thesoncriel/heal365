...
<a:html title=" - User Action Test : Join" contents="sub901_1">
	...
	<div class="section">
		<div class="article member-join finish">
			...
			<div style="padding: 3em 3em 0 3em;">
				...
				<p>k-wellness와 함께 매일매일 건강을 챙기세요!</p>
				<br/>
				<p style="text-align: right">병원 등록을 바로 진행 하시겠습니까?</p>
			</div>
			<hr/>
			<div style="text-align: right;">
				<a href="/group/list" class="artn-button board">등록 하기</a> <a href="/main" class="artn-button board">다음에</a>
			</div>
		</div>
	</div>
</a:html>