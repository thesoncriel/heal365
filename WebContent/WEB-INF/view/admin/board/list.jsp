		...
		<div class="article">			
			...
			<input type="hidden" value="${contentsCode }" name="contents"/>							
				<table class="board-manager">
					...
					<tbody>
						...
						<tr>
							...
							<td><s:select name="view" list="#{'normal':'일반 게시판', 'file':'자료 게시판', 'img':'사진 게시판' ,'notice':'공지사항', 'guest':'익명게시판' }" theme="simple" value="view"></s:select></td>  
				...
				<div class="footer board">
					<div class="buttons">
						<button class="artn-button board" type="button" id="button_boardManager_addRow">추가</button>
						<button class="artn-button board" type="submit" id="button_boardManager_modify">수정</button>
					</div>
				</div>
			</form>
		</div>
