...
<div class="buttons show">
		...
		<a href="delete?id=${param.id}&amp;board_no=${param.board_no}&amp;contents=${param.contents}" data-rule="confirmButton" data-dialog="#dialog">삭제</a>		
		<s:if test="showData.depth < 10"><a class="artn-button board" href="write?id=${param.id}&board_no=${param.board_no}&depth=${showData.depth+1}&re=re&subject=${showData.subject}&amp;contents=${param.contents}">답글</a></s:if>				
