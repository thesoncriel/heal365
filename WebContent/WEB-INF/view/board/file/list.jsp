		...
		<form action="delete">
			...
			<tbody>				
				...
				<tr>
					...
					<td><s:if test="(status & 8) > 0"><span class="artn-icon-16 chain">있음</span></s:if><s:else><span class="artn-icon-16 chainoff"></span></s:else></td>
			...
			<div class="footer board">
				<div class="buttons">
					...
					<s:if test="auth.isAdmin"><input class="artn-button board" type="submit" value="삭제"></s:if>
				</div>
				<a:pagenav page="${param.page }" params="${params }" rowCount="${rowCount }" rowLimit="${param.rowlimit }" navCount="20" id="pagecontroller" cssClass="page-controller" font="symbol" />
			</div>
