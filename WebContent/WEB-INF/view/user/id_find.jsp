...
<div class="article">
    <div class="user-find">
	        ...
	        <table class="board-edit delivery">	               
	                <tbody class="row-scope">
	                    <tr>
	                    	...
	                    	<td><input type="text" class="name" name="name" required="required"/></td>	                      
	                    </tr>
	                    <tr>
	                    	<th><label>핸드폰</label></th>
	                    	<td><a:phone id="phonebox_phone_mobi1" name="phone_mobi1" value="${showData.phone_mobi }" type="phone_mobi" required="required"/></td>
	                    </tr>
	                </tbody>
	                <tfoot>
	                	<tr>
	                		<td colspan="2"><input type="button" id="id_find" class="artn-button board" value="아이디 확인하기"/></td>
	                	</tr>
	                </tfoot>
	            </table>
	        </form>
	           ...
	           <table class="board-edit delivery">	               
	                <tbody class="row-scope">
	                    <tr>
	                    	...
	                    	<td><input type="text" class="id" name="id" required="required"/></td>						
	                    </tr>
	                    <tr>
	                    	<th><label>이름</label></th>
	                    	<td><input type="text" class="name" name="name" required="required"/></td>
	                    ...
	                    <tr>
	                    	<th><label>핸드폰</label></th>
	                    	<td><a:phone id="phonebox_phone_mobi2" name="phone_mobi2" value="${showData.phone_mobi }" type="phone_mobi" required="required"/></td>
	                    </tr>
	                </tbody>
	                <tfoot>
	                	<tr>
	                		<td colspan="2"><input type="button" id="passwd_find" class="artn-button board" value="메일로 비밀번호 전송"/></td>
	                	</tr>
	                </tfoot>
	            </table>
	        </form>
		...
		<div id="dialog_emailResult" data-width="500" data-height="300" style="text-align: center;">
           	<p style="background-image: url(/img/constact-us2.gif); background-position:50%, 50%; text-indent: -65000px; height: 200px;">이메일 전송완료</p>
