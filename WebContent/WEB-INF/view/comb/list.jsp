...
<a:html title=" - 조합 등록 및 관리" contents="${contentsCode }">
<div class="header">
    <h1>조합 관리</h1>
...
<div class="section">
    <div class="article">   
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="img"><s:if test='%{file_img == "" || file_img == null}'><img src="/img/Heal365-logo-mini.png" alt="썸네일" height="35" /></s:if>
                    	<s:else><a href="/player/player?id=${id}&menu=${param.menu}&depth=list"><img src="/media/img/${file_img}" alt="썸네일" height="35" /></a></s:else></td>
                    <td class="title"><a href="edit.action?id=${id}&menu=${param.menu}&contents=${contentsCode }"><s:property value="subject"/></a><!-- <br/><xsl:value-of select="subject_movie"/> --></td>
        ...
        <div class="footer board">
            <div class="buttons">
				<a href="edit.action?contents=${contentsCode }" class="artn-button board">추가</a>
	        </div>		        
