...
valuebox.setWrap(wrap).setZero(zero).setIcon(icon).setCssCheckedClass(cssCheckedClass).setCssUncheckedClass(cssUncheckedClass).setList(list).setListKey(listKey);
