...
<a:html title=" - Group Action Test : Edit" contents="${param.contents }">
<div class="layout-contents">
            
<div class="section">
<div class="article comb365plus-edit">
	<h3>조합 영상 <s:property value="%{(showData != null) ? '변경' : '추가'}"/></h3>
<form action="modify.action" method="post">
		...
		<table>
			<tbody>
				...
				<tr><th><label>영상 조합</label><br/>
					<span class="artn-button search"><a href="#" id="anchor_AddMovie">영상 추가하기</a></span></th><!--  <a href="#" id="anchor_AddFromComb">기존 조합을 추가</a> -->
				
					<td><ul id="list_MovieContent365plus">
 ...
 -->
	...
	<div class="footer board">
            <div class="buttons">
		        <span class="artn-button board"><a href="list.action">취소</a></span>
		        <span class="artn-button board"><s:if test='%{showIsNull == true}'><input type="submit" value="추가"/></s:if>
					<s:else><input type="submit" value="변경"/></s:else></span>
	        </div>
       	</div>
</form>
...
<button id="button_SelectionComplete" type="button">선택 완료</button>
